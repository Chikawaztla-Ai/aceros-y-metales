...
const publico: Screen[] = [
  ...
  { href: '/calculadora', label: 'Calculadora Técnica', desc: 'Peso teórico y costo estimado por material y perfil.', icon: 'calculate' },
...
const admin: Screen[] = [
  ...
  { href: '/admin/inventario/abc', label: 'Análisis de Inventario', desc: 'Vista detallada con filtros, alertas y valor de inventario.', icon: 'analytics' },
  { href: '/admin/inventario/editar', label: 'Editar Producto', desc: 'Alta/edición de material con calculadora de peso teórico.', icon: 'edit_note' },
  { href: '/admin/categorias', label: 'Categorías y Precios', desc: 'Categorías del catálogo y reglas de precio globales.', icon: 'category' },
  ...
  { href: '/admin/rutas', label: 'Rutas y Operadores', desc: 'Mapa en vivo, en tránsito y estado de operadores.', icon: 'route' },
  { href: '/admin/mantenimiento', label: 'Flota y Mantenimiento', desc: 'Estatus operativo, servicios preventivos y próximos retiros.', icon: 'build' },
  { href: '/admin/pod', label: 'POD y Pesajes', desc: 'Remisiones, tickets de báscula y pruebas de entrega.', icon: 'fact_check' },
